...
class DiseasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disease" do
    assert_difference('Disease.count') do
      post diseases_url, params: { disease: { curable: @disease.curable, name: @disease.name, severity: @disease.severity, source: @disease.source } }
    end
  ...
  test "should update disease" do
    patch disease_url(@disease), params: { disease: { curable: @disease.curable, name: @disease.name, severity: @disease.severity, source: @disease.source } }
