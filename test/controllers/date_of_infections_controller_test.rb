...
class DateOfInfectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create date_of_infection" do
    assert_difference('DateOfInfection.count') do
      post date_of_infections_url, params: { date_of_infection: { animal_id: @date_of_infection.animal_id, date_of_infection: @date_of_infection.date_of_infection, disease_id: @date_of_infection.disease_id } }
    end
  ...
  test "should update date_of_infection" do
    patch date_of_infection_url(@date_of_infection), params: { date_of_infection: { animal_id: @date_of_infection.animal_id, date_of_infection: @date_of_infection.date_of_infection, disease_id: @date_of_infection.disease_id } }
